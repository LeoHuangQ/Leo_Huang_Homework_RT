export function destructurePerson1() {
  ...
  return "${person.name} is ${person.age} years old and is a ${person.job}";
}
...
export function destructureArray2() {
  ...
  // Write your code here
  const [fun1, fun2, fun3, fun4] = methods;
  console.log(fun1);
}
...
export function destructureArray3() {
  ...
  // Write your code here
  const [item1, item2, item3, ...rest] = arr;
  console.log(item1, item2, item3, rest);
}
